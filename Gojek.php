...
$headers[] = 'X-Location: -6.405821,106.064193';
        ...
        if($regs->success == true) {
            ...
            if($verifs->success == true) {
                ...
                // SANTAI19
                echo "\e[96m[!] Proses Reedem Voucher 20+10 : GOJEKINAJA \n";
                $data3 = '{"promo_code":"GOJEKINAJA"}';
                                        ...
                                        if($claims1->success == true) 
                                                {
                                                ...
                                                } else 
                                                    {
                                                        echo "\e[91m [×] Gagal Claim Voucer !";
                                                            ...
                                                            // SANTAI08
                                                                echo "\e[96m[!] Proses Redeem Voucher 15+10 : GOJEKINAJA \n";
                                                                $data5 = '{"promo_code":"GOJEKINAJA"}';
                                                                ...
                                                                if($claims2->success == true) 
                                                                        {
                                                                        ...
                                                                        } else 
                                                                            {
                                                                                echo "\e[91m [×] Gagal Claim Voucer !";
                                                                                    ...
                                                                                    // SANTAI08
                                                                                        echo "\e[96m[!] Proses Redeem Voucher 10+10 : GOJEKINAJA \n";
                                                                                        $data6 = '{"promo_code":"GOJEKINAJA"}';
